...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_ai_tasks,
            commands::list_news,
            commands::list_news_by_ids,
            commands::list_calendar_events,
            commands::list_market_events,
            ...
            commands::list_market_assets,
            commands::get_market_leaderboard,
            commands::get_asset_sparkline,
            ...
            commands::get_database_domain_summary,
            commands::sync_data_domain,
            commands::export_data_domain,
            commands::cleanup_data_domain,
            // A 股
            ...
            commands::list_watchlist_groups,
            commands::save_watchlist_group,
            commands::delete_watchlist_group,
            commands::list_watchlist_items,
            commands::save_watchlist_item,
            commands::delete_watchlist_item,
            commands::get_watchlist_summary,
            commands::get_watchlist_events,
